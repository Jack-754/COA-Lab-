...
#
# Script generated by Vivado on Tue Nov 12 14:55:46 +0530 2024
...
#
# Usage        : instruction_mem.sh
#                instruction_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                instruction_mem.sh [-reset_run]
#                instruction_mem.sh [-reset_log]
#                instruction_mem.sh [-help]
#
...
#                script (type 'instruction_mem.sh -help' for more information).
#
...
# script info
echo -e "instruction_mem.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./instruction_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.instruction_mem xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.instruction_mem -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log instruction_mem_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: instruction_mem.sh [-step]\n\
Usage: instruction_mem.sh [-lib_map_path]\n\
Usage: instruction_mem.sh [-reset_run]\n\
Usage: instruction_mem.sh [-reset_log]\n\
Usage: instruction_mem.sh [-keep_index]\n\
