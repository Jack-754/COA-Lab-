...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot processor_tb xil_defaultlib.processor_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim processor_tb -key {Behavioral:sim_1:Functional:processor_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb processor_tb.wdb xsim.dir libdpi.so)
