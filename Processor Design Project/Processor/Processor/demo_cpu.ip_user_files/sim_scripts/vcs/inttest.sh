...
#
# Script generated by Vivado on Sun Oct 27 13:26:10 +0530 2024
...
#
# Usage        : inttest.sh
#                inttest.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                inttest.sh [-reset_run]
#                inttest.sh [-reset_log]
#                inttest.sh [-help]
#
...
#                script (type 'inttest.sh -help' for more information).
#
...
# script info
echo -e "inttest.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./inttest.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../Final/ CPU/Final/ CPU.srcs/sim_1/new/inttest.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.inttest xil_defaultlib.glbl -o inttest_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./inttest_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key inttest_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc inttest_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./inttest.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: inttest.sh [-help]\n\
Usage: inttest.sh [-step]\n\
Usage: inttest.sh [-lib_map_path]\n\
Usage: inttest.sh [-reset_run]\n\
Usage: inttest.sh [-reset_log]\n\
Usage: inttest.sh [-keep_index]\n\
Usage: inttest.sh [-noclean_files]\n\n\
