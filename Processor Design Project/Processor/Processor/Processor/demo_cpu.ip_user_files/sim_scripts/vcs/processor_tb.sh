...
#
# Script generated by Vivado on Wed Oct 30 16:16:45 +0530 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : processor_tb.sh
...
#
# Usage        : processor_tb.sh
#                processor_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                processor_tb.sh [-reset_run]
#                processor_tb.sh [-reset_log]
#                processor_tb.sh [-help]
#
...
#                script (type 'processor_tb.sh -help' for more information).
#
...
# script info
echo -e "processor_tb.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./processor_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/ALU.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/imports/Q2/CLA_16_bit_lookahead.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/imports/Q2/CLA_4_bit_augmented.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/MUX_2to1.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/new/MUX_4to1.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/new/PIPO_module.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/add_module.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/adder_2bit.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/adder_3bit.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/and_module.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/new/comparator.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/complement_module.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/new/computational_block.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/new/control_unit.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/new/decoder_16bit.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/new/decoder_8bit.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/imports/Q1/full_adder.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/hamm.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/new/instruction_decoder.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/imports/Q2/look_ahead_unit.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/lui_module.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/imports/ALU/mux_2_1.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/imports/shift/mux_32_1.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/or_module.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/new/processor.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/new/register_bank.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/imports/ALU/reverse_bits.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/imports/ALU/sar_module.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/new/signextend.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/imports/ALU/sll_module.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/imports/ALU/slr_module.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/new/time_step.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sources_1/imports/sources_1/new/xor_module.v" \
  "../../../../Final/ CPU/Final/ CPU.srcs/sim_1/new/processor_tb.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.processor_tb xil_defaultlib.glbl -o processor_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./processor_tb_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key processor_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc processor_tb_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./processor_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: processor_tb.sh [-help]\n\
Usage: processor_tb.sh [-step]\n\
Usage: processor_tb.sh [-lib_map_path]\n\
Usage: processor_tb.sh [-reset_run]\n\
Usage: processor_tb.sh [-reset_log]\n\
Usage: processor_tb.sh [-keep_index]\n\
Usage: processor_tb.sh [-noclean_files]\n\n\
